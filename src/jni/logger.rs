...
#[no_mangle]
extern "system" fn Java_com_tuguzT_native_Logger_error(
    env: JNIEnv,
    _class: JClass,
    message: JString,
) {
...
#[allow(non_snake_case)]
#[no_mangle]
extern "system" fn Java_com_tuguzT_native_Logger_warn(
    env: JNIEnv,
    _class: JClass,
    message: JString,
) {
...
#[allow(non_snake_case)]
#[no_mangle]
extern "system" fn Java_com_tuguzT_native_Logger_info(
    env: JNIEnv,
    _class: JClass,
    message: JString,
) {
...
#[allow(non_snake_case)]
#[no_mangle]
extern "system" fn Java_com_tuguzT_native_Logger_debug(
    env: JNIEnv,
    _class: JClass,
    message: JString,
) {
